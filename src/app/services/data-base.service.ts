...
export class DataBaseService {
  ...
  async crearUsuariosDePrueba() {
    await this.guardarUsuario(Usuario.getUsuario('admin@admin.cl', 'admin', 'admin', 'admin', 'Nombre de mi mascota', 'admin'));

    await this.guardarUsuario(Usuario.getUsuario('atorres@duocuc.cl', '1234', 'Ana', 'Torres', 'Nombre de mi mascota', 'gato'));
    await this.guardarUsuario(Usuario.getUsuario('avalenzuela@duocuc.cl', 'qwer', 'Alberto', 'Valenzuela', 'Mi mejor amigo', 'juanito'));
    await this.guardarUsuario(Usuario.getUsuario('cfuentes@duocuc.cl', 'asdf', 'Carla', 'Fuentes', 'Dónde nació mamá', 'valparaiso'));
  }
