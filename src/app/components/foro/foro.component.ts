...
import { Component, ElementRef, NgModule, OnInit, ViewChild, AfterViewInit } from '@angular/core';
...
export class ForoComponent implements OnInit  {
  ...
  ngAfterViewInit(): void {
    // Desplazar la página hacia arriba después de que la vista se haya inicializado
    window.scrollTo(0, 0);
  }
